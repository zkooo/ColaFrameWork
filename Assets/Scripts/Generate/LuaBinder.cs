...
public static class LuaBinder
{
    ...
    /// <returns></returns>
    private static int InnerPrint(IntPtr L, bool traceback = true)
    {
    ...
    /// <param name="traceback"></param>
    /// <returns></returns>
    private static int InnerPrintTable(IntPtr L, bool traceback = true)
    {
