...
main.py主要完成包括，清除QQ、微信、游戏数据，拉起游戏，等待wetest sdk启动等工作。准备工作完成后，会调用testcase.runner.run函数，测试逻辑的起点

本地启动，只运行一台手机的:
usage:
    设置游戏包名，main.py往下，找到local_package = os.environ.get("PKGNAME", ""),设置包名，如找到local_package=com.tencent.wetest.demo
     python main.py
